<template>
  <div class=" bg-gray-50 h-full top-0 fixed w-full flex flex-col gap-5 items-center p-10">
    <div class="pt-20">
    ...
    <div class="flex gap-5 py-20 items-center">
      <div class="flex flex-col gap-5 items-center">
        <input type="text" v-model="phoneNumber" placeholder="Entrez votre numero" class="text-gray-600 rounded border border-gray-200 h-10 px-2 focus:shadow-xl focus:outline-none focus:border-gray-600">
      ...
      <button @click="checkValidation" class="border border-blue-400 h-10 px-5 rounded bg-blue-400 text-white text-lg hover:bg-blue-500 hover:border-blue-500">Soumettre</button>
    </div>
  </div>
